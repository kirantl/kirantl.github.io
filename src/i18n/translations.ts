...
<p>Effective machine learning systems are not defined by complexity, but by how well they <strong>align with the structure of the problem</strong> they are designed to solve.</p>`,
          ...
          },
          {
            ...
            content: '<div class="not-prose mb-5 rounded-lg bg-amber-50/70 dark:bg-amber-900/15 border border-amber-200/60 dark:border-amber-700/40 px-4 py-3"><p class="text-sm text-amber-800 dark:text-amber-300 flex items-center gap-2"><svg class="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg><span>A detailed article for this project is coming soon.</span></p></div><p>Designed a <strong>cross-sell recommendation engine</strong> for non-food products based on transactional sales history analysis. The engine identifies products frequently bought together to suggest complementary items at the product page level.</p><p>Implemented the <strong>Apriori algorithm</strong> on millions of transactions to extract high-confidence association rules (support, confidence, lift). Rules are filtered and ranked by business relevance and refreshed weekly via an <strong>Airflow pipeline</strong>. Contributed to a measurable increase in average basket value.</p>',
            items: [
      ...
      genai: {
        ...
        items: [
          ...
          },
          {
            ...
            tagline: 'OCR · LLM · Automatisation',            icon: 'tabler:tag',            content: '<div class="not-prose mb-5 rounded-lg bg-amber-50/70 dark:bg-amber-900/15 border border-amber-200/60 dark:border-amber-700/40 px-4 py-3"><p class="text-sm text-amber-800 dark:text-amber-300 flex items-center gap-2"><svg class="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg><span>Un article d&eacute;taill&eacute; pour ce projet sera bient&ocirc;t disponible.</span></p></div><p>Développement d\'une <strong>solution basée sur les LLM</strong> pour extraire automatiquement les informations structurées des étiquettes poisson (via OCR à partir de photos prises en magasin), pré-remplir les formulaires réglementaires associés et proposer un <strong>top-10 de codes internes produits correspondants</strong> (CUG).</p><p>Le pipeline utilise l\'<strong>API Google Cloud Vision</strong> pour l\'OCR, suivi de Gemini pour l\'extraction d\'entités et la génération de sorties structurées. Réduction de plus de 80% du temps de saisie manuelle pour les équipes magasin et amélioration de la qualité des données réglementaires.</p>',
            items: [
              { title: 'LLM (Gemini)' },
              { title: 'OCR (Cloud Vision)' },
